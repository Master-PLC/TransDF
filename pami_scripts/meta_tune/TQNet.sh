...
# datasets=(ECL Traffic PEMS03 PEMS08)
# datasets=(Traffic)
# datasets=(Traffic)
...
for meta_type in ${meta_type_list[@]}; do
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lr_inner}_${lr_meta}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_batch_size}_${reg_lambda}_${max_norm}_${num_tasks}_${overlap_ratio}_${meta_inner_steps}_${auxi_loss}_${cycle}_${dropout}_${model_type}_${use_revin}_${first_order}_${meta_steps}_${meta_type}
...
# pl_list=(96 192 336 720)
# lbd_list=(1.0)
# lr_list=(0.005 0.004 0.006 0.008 0.01)
# inner_lr_list=(same)
# meta_lr_list=(0.01 0.03 0.05 0.1 0.15 0.2)
# lradj_list=(type1)
# bs_list=(16)
# auxi_bs_list=(64)
# max_norm_list=(5.0)
...
# pl_list=(96 192 336 720)
# lbd_list=(1.0)
# lr_list=(0.005 0.004 0.0045)
# inner_lr_list=(same)
# meta_lr_list=(0.01 0.03 0.05 0.1 0.15)
# lradj_list=(type1)
# bs_list=(16)
# auxi_bs_list=(64)
# max_norm_list=(5.0)
...
# lr_list=(0.005 0.004)
# inner_lr_list=(same)
# meta_lr_list=(0.01 0.03 0.02)
# lradj_list=(type1 TST)
# bs_list=(8)
# auxi_bs_list=(32)
# max_norm_list=(5.0)
# reg_lambda_list=(0.01 0.02 0.005)
# num_tasks_list=(2 3)
# overlap_ratio_list=(0.0)
# meta_inner_steps_list=(1 2)
# meta_step_list=(100 200)
# auxi_loss_list=(MSE)
