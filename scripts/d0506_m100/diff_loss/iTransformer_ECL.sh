...
seed=2023
des='iTransformer'
# total_modes=(soft_dtw dtw)
total_modes=(soft_dtw)
# total_modes=(dilate_cuda dpp soft_dtw)
# total_modes=()
...
# for lambda in 0.9995 0.0 0.995; do
for lambda in 0.9995 0.99995 0.999995; do
for lr in ${lr_list[@]}; do
for pl in ${pl_list[@]}; do
    if ! [[ " ${total_modes[@]} " =~ " ${auxi_mode} " ]]; then
        continue
