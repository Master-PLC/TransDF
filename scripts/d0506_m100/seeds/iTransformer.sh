...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.001 lambda=0.2 rank_ratio=1.0;;
        192) lr=0.001 lambda=0.3 rank_ratio=0.5;;
        336) lr=0.001 lambda=0.2 rank_ratio=1.0;;
        720) lr=0.001 lambda=0.2 rank_ratio=0.3;;
    esac
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_loss}_${use_weights}_${reinit}_${pca_dim}_${rank_ratio}_${seed}
    OUTPUT_DIR="./results_PCA/${EXP_NAME}/${JOB_NAME}"
...
pl_list=(96 192 336 720)
lbd_list=(0.0 0.2 0.4 0.8)
lr_list=(0.001 0.0005 0.0001)
rank_ratio_list=(0.2 0.3 0.5 0.6 1.0)
bs_list=(8 32)
pca_dim_list=(T)
reinit_list=(1)
auxi_loss_list=(MAE)
...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.0005 lambda=0.2 rank_ratio=0.2;;
        192) lr=0.001 lambda=0.0 rank_ratio=0.8;;
        336) lr=0.0005 lambda=0.2 rank_ratio=0.1;;
        720) lr=0.001 lambda=0.0 rank_ratio=0.8;;
    esac
