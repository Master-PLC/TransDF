...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.001 rank_ratio=0.6 lambda=0.4;;
        192) lr=0.001 rank_ratio=0.6 lambda=0.4;;
        336) lr=0.001 rank_ratio=0.2 lambda=0.4;;
        720) lr=0.001 rank_ratio=0.2 lambda=0.4;;
    esac
