...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.0005 rank_ratio=1.0 lambda=0.0;;
        192) lr=0.0005 rank_ratio=1.0 lambda=0.0;;
        336) lr=0.0005 rank_ratio=1.0 lambda=0.0;;
        720) lr=0.0005 rank_ratio=0.8 lambda=0.0;;
    esac
...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.00005 rank_ratio=1.0 lambda=0.0;;
        192) lr=0.0005 rank_ratio=0.6 lambda=0.0;;
        336) lr=0.0005 rank_ratio=0.2 lambda=0.2;;
        720) lr=0.0001 rank_ratio=1.0 lambda=0.0;;
    esac
...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.0005 rank_ratio=1.0 lambda=0.6;;
        192) lr=0.0005 rank_ratio=1.0 lambda=0.2;;
        336) lr=0.0005 rank_ratio=0.6 lambda=0.2;;
        720) lr=0.0005 rank_ratio=0.8 lambda=0.0;;
    esac
...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.00005 rank_ratio=0.8 lambda=0.0;;
        192) lr=0.0005 rank_ratio=1.0 lambda=0.0;;
        336) lr=0.00005 rank_ratio=1.0 lambda=0.0;;
        720) lr=0.0001 rank_ratio=0.8 lambda=0.0;;
    esac
    ...
    # else
    #     subdirs=("$RESULTS"/*)
    #     if [ ${#subdirs[@]} -eq 1 ] && [ -f "${subdirs[0]}/pred.npy" ]; then
    #         echo ">>>>>>> Job: $JOB_NAME already run, skip <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"
    #         continue
    #     fi
    fi
...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) lr=0.005 rank_ratio=0.8 lambda=0.2;;
        192) lr=0.005 rank_ratio=1.0 lambda=0.0;;
        336) lr=0.005 rank_ratio=0.6 lambda=0.2;;
        720) lr=0.005 rank_ratio=0.6 lambda=0.0;;
    esac
