...
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${sl}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}
    OUTPUT_DIR="./results_PCA/${EXP_NAME}/${JOB_NAME}"
...
# hyper-parameters
dst=Weather_PCA
sl_list=(96 192 336 720)
pl_list=(96 192 336 720)
lbd_list=(0.0 0.2 0.5)
lr_list=(0.001 0.0005 0.0001)
rank_ratio_list=(0.1 0.2 0.8)
pca_dim_list=(T)
reinit_list=(1)
auxi_loss_list=(MAE)
use_weights_list=(0)
...
for pl in ${pl_list[@]}; do
    ...
    case $sl in
        96) n_heads=4 batch_size=32;;
        192) n_heads=16 batch_size=32;;
        336) n_heads=4 batch_size=128;;
        720) n_heads=4 batch_size=128;;
    esac
    ...
    JOB_NAME=${model_name}_${dst}_${sl}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_loss}_${use_weights}_${reinit}_${pca_dim}_${rank_ratio}
    OUTPUT_DIR="./results_PCA/${EXP_NAME}/${JOB_NAME}"
