...
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lradj}_${decomposition}_${train_epochs}_${patience}_${batch_size}_${d_model}_${d_ff}
    ...
    echo "Running command for $JOB_NAME"
    {
        ...
        CUDA_VISIBLE_DEVICES=$gpu_allocation python -u run.py \
            --task_name long_term_forecast_rtn_loss \
            --is_training 1 \
